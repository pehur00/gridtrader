        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div className="flex items-center">
              <h1 className="text-2xl font-bold text-gray-900">GridTrader</h1>
            </div>
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mb-8">
            ...
            <p className="mt-2 text-gray-600">
              Here's what's happening with your grid trading strategies today.
            </p>
          </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Active Grids</dt>
            ...
            <div className="px-4 py-5 sm:p-6">
              ...
              <div className="text-center py-8">
                ...
                <p className="mt-1 text-sm text-gray-500">
                  Get started by creating your first grid strategy.
                </p>
                <div className="mt-6">
